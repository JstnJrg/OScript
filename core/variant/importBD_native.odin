...
register_natives :: proc() 
{
	...
	register_import_native_importID("Oscript",   import_default_set,import_get)
	...
	register_import_native_importID("FileAcess", import_default_set,import_get)
...
register_method :: proc(id: ImportID, name: string, method : NativeFn) { table_set_s(get_import_context_importID(id),name,NATIVE_OP_FUNC_VAL(method)) }

register_value :: proc(id: ImportID, name: string, value : Value)      { table_set_s(get_import_context_importID(id),name,value) }
